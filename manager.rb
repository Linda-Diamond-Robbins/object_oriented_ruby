...
# using this has duplicate variables is easy to cut and paste but you've made it difficult for yourself by using duplicates.  Called dry-don't repeat yourself
# wet stands for write everything twice
#inheritance- 
# manager is inheriting from employee
#class Manager < Employee

# employee1 is an instance